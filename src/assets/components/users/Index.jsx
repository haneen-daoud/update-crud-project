...
users.map((user,index)=>(
    <React.Fragment key={user._id}>
        <tr>
            ...
            <td>{user.email}</td>
            <td>{user.password}</td>
            <td className=' btn  text-decoration-none ' onClick={()=>{deleteUser(user._id)}}> delete</td>
            <td className=' btn   text-decoration-none '><Link to={`/user/${user._id}`}>details</Link></td> 
            <td className=' btn  text-decoration-none '><Link to={`/user/edit/${user._id}`}>edit</Link></td> 
