...
<div className="card-body w-50  d-flex justify-content-center align-items-center">
<img className="" src={image_url} alt="Card image cap" />
<div>
  <h5 className=" text-white border ">Name : {user.name}</h5>
  <p className=" text-white border ">Email : {user.email}</p>
  <p className=" text-white border ">Password : {user.password}</p>
  </div>
</div>
